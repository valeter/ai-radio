...
s3fs ai-radio-music /music -o passwd_file=/etc/secrets/aws_creds -o url=https://storage.yandexcloud.net/ -o allow_other -o umask=0007,uid=$ICECAST_UID,gid=$ICECAST_GID
